...
class FeedServiceImplTest {
    ...
    void anonymousFirstPageUsesFastGlobalPath() {
        ...
        when(recommendationMapper.selectColdStart(0, 300)).thenReturn(List.of(image));
        ...
        verifyNoInteractions(behaviorMapper, vectorRecallClient, rankingModelClient);
    ...
    void userHomeDemotesRecentlyInteractedImages() {
        ...
        when(behaviorMapper.findRecentSeenImageIds(7L, null, 1200)).thenReturn(List.of(1L));
