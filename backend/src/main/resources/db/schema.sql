...
CREATE TABLE user_behaviors (
  ...
  source VARCHAR(48),
  score DECIMAL(12,6),
  UNIQUE KEY uk_user_behaviors_event_id (event_id),
  KEY idx_user_behaviors_decision (decision_id),
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE feed_impressions (
  ...
  UNIQUE KEY uk_feed_impressions_event_id (event_id),
  KEY idx_feed_impressions_decision (decision_id),
  KEY idx_feed_impressions_occurred (occurred_at),
